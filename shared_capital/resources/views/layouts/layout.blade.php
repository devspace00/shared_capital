                ...
                <ul class="clearfix">
                    <li class="icons dropdown">
                        <div class="user-img c-pointer position-relative"   data-toggle="dropdown">
                            ...
                            <img src="image/logout.png" height="40" width="40" alt="" >
                        </div>
                ...
                <li>   
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="Transaction_History" aria-expanded="false">Transaction History</a></li>
                            <li><a href="Members_History">Client History</a></li>                           
                            <li><a href="{{ route('membersContri') }}" aria-expanded="false">{{--<img src="image/contribution.png" width="15px" height="15px" style="margin-right: 5px;">--}}Client Contribution</a></li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route('membersRequest') }}">Client Request</a></li>
                        </ul>
                    </li>
